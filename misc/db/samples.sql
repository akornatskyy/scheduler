...
('1hZsD7XGqPE','My Task #1','2020-03-29 13:30:30.342','xebs7HqKQpU',2,'@every 15s','{"type":"HTTP","request":{"method":"GET","uri":"http://localhost:8080/test","headers":[{"name":"X-Requested-With","value":"XMLHttpRequest"}]},"retryPolicy":{"retryCount":3,"retryInterval":"10s","deadline":"1m0s"}}'),
